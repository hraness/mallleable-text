...
The root `AGENTS.md` is the repository's normative control plane. Its rules apply before deeper lookup. Mallleable Text is a public Convex and React package for source-backed plain-text authoring, with authentication and product policy owned by each host.
